-- ============================================================
-- Folk Reuniões — Reset completo (apaga e recria tudo)
-- ============================================================
...
-- Remove tabelas antigas (incluindo as com empresa_id)
DROP TABLE IF EXISTS public.dados_projetos    CASCADE;
DROP TABLE IF EXISTS public.dados_comerciais  CASCADE;
...
-- ============================================================
-- 6. Para tornar um usuário admin:
