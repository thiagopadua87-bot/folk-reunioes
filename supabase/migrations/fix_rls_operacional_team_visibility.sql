-- Corrige visibilidade e edição de Gestão de Crise, Clientes Perdidos e crisis_actions para todos os usuários aprovados.
-- Qualquer usuário aprovado pode ler, criar e editar. Exclusão restrita ao admin (reforçada no app).
...
-- ── Crisis Actions ───────────────────────────────────────────
DROP POLICY IF EXISTS "Acesso a crisis_actions" ON public.crisis_actions;
